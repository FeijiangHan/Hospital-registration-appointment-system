...
public class MainActivity_ys extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(Main_sy_ys.newInstance("首页"));
        fragments.add(Main_rcap.newInstance("首页"));

        fragments.add(Main_grzx_ys.newInstance("个人中心"));
        tab_titles = new String[]{"首页","查看日程", "个人中心"};
        tab_imgs=new int[]
